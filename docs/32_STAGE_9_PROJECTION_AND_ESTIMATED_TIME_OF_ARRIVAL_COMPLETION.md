...
The reconciliation implementation commit must pass Backend Quality, Backend Race Safety, PostgreSQL 16
Integration, and Backend Container. A separate formal-closure increment will record that exact evidence.
