...
var metricCatalog = []MetricSpec{
	...
	{Name: MetricNameActiveRoutes, Unit: "routes", Aggregation: AggregationCount, ValueKind: MetricValueKindCount, Family: MetricFamilyRoute, AllowedScopes: []ScopeType{ScopeTypeGlobal, ScopeTypeRoute}},
	...
	{Name: MetricNameCompleteRouteRatio, Unit: "ratio", Aggregation: AggregationRatio, ValueKind: MetricValueKindRatio, Family: MetricFamilyRoute, AllowedScopes: []ScopeType{ScopeTypeGlobal, ScopeTypeRoute}},
	{Name: MetricNamePartialRouteRatio, Unit: "ratio", Aggregation: AggregationRatio, ValueKind: MetricValueKindRatio, Family: MetricFamilyRoute, AllowedScopes: []ScopeType{ScopeTypeGlobal, ScopeTypeRoute}},
	{Name: MetricNameUnavailableRouteRatio, Unit: "ratio", Aggregation: AggregationRatio, ValueKind: MetricValueKindRatio, Family: MetricFamilyRoute, AllowedScopes: []ScopeType{ScopeTypeGlobal, ScopeTypeRoute}},
