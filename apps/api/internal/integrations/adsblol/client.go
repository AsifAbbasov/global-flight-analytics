...
func NewClientWithResponseObserver(
	...
	if err := config.Validate(); err != nil {
		return nil, fmt.Errorf(
			"validate adsb.lol http client config: %w",
			err,
		)
	}
...
func (c *Client) GetByCallsign(
	...
	if err != nil {
		return nil, fmt.Errorf(
			"build adsb.lol callsign request: %w",
			err,
		)
	}
	...
	if err != nil {
		return nil, fmt.Errorf(
			"execute adsb.lol callsign request: %w",
			err,
		)
	}
...
func (c *Client) GetByPoint(
	...
	if err != nil {
		return nil, fmt.Errorf(
			"build adsb.lol point request: %w",
			err,
		)
	}
	...
	if err != nil {
		return nil, fmt.Errorf(
			"execute adsb.lol point request: %w",
			err,
		)
	}
