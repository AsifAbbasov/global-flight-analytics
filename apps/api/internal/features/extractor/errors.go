...
var (
	...
	ErrMixedRequirementGroupEvidence           = errors.New("mixed required and optional aggregate evidence is unsupported")
	ErrAircraftMetadataSourceNameRequired      = errors.New("aircraft metadata source name is required")
	ErrAircraftMetadataProviderVersionRequired = errors.New("aircraft metadata provider version is required")
)
