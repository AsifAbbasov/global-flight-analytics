...
func validProductionPattern() projectionpatternconfidence.Result {
	return projectionpatternconfidence.Result{
		...
		Score:                            0.92600000000000005,
		Level:                            projectioncontract.ConfidenceLevelHigh,
		Components: []projectionpatternconfidence.Component{
			{Name: projectionpatternconfidence.ComponentSimilarityStrength, Score: 0.85, Weight: 0.20000000000000001},
			{Name: projectionpatternconfidence.ComponentSupport, Score: 1, Weight: 0.20000000000000001},
			{Name: projectionpatternconfidence.ComponentSimilarityConsistency, Score: 0.9, Weight: 0.20000000000000001},
			{Name: projectionpatternconfidence.ComponentAnchorProximity, Score: 0.97999999999999998, Weight: 0.20000000000000001},
