	...
	return []requirement{
		...
		},
		{
			...
			forbidden: []string{
				...
				"PROJECTION_NEIGHBORS_PERMANENT_AUDIT_GITHUB_ACTIONS_RUN=PENDING",
		...
		},
		{
			...
			fragments: []string{
				...
				"c409cc171507050625524af1a0b8b8a6f38b7a75",
				"30452465009",
				"formal closure with zero open, unclassified, or deferred findings",
			},
			forbidden: []string{
				"formal closure pending permanent audit Continuous Integration",
			},
		},
		{
