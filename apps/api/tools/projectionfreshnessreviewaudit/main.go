...
func reviewRequirements() []requirement {
	return []requirement{
		...
		},
		{
			...
			forbidden: []string{
				"PROJECTION_FRESHNESS_PERMANENT_AUDIT_COMMIT=PENDING",
		...
		},
		{
			...
			fragments: []string{
				...
				"619e24878a5025decf6fe21abddba537ce195560",
				"30523502590",
				"formal closure with zero open, unclassified, or deferred",
			},
			forbidden: []string{
				"Projection Freshness formal closure pending",
			},
		},
		{
