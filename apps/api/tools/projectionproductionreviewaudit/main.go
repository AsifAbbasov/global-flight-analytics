	...
	return []requirement{
		...
		},
		{
			...
			forbidden: []string{
				...
				"UPDATED_PENDING_EXACT_CI",
				"CORRECTIVE_IMPLEMENTATION_COMPLETE_PENDING_EXACT_CI",
				"OPEN_PENDING_EXACT_CI_AND_FORMAL_RECLOSURE",
		...
		},
		{
			...
			fragments: []string{
				...
				"is the formally reclosed review",
				"fingerprint and canonical provenance reconstruction",
				"corrective engineering commit and Continuous Integration evidence",
