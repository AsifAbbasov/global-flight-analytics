...
test('README records current engineering closure and remaining v1 boundary', async () => {
  ...
  assert.match(readme, /39 source-backed OpenAPI paths/)
  ...
  assert.match(readme, /OPENAPI_CONTRACT_PATHS=39/)
  assert.match(readme, /PLAYWRIGHT_E2E_BROWSER_SCENARIOS=20/)
  assert.match(readme, /FRONTEND_VISUAL_AND_INTERACTION_REDESIGN=IN_PROGRESS/)
